...
async function run() {
  ...
  catch (e: any) { errors.value = e.message || '実行エラー'; }
...
<template>
  <div class="dashboard">
    <header class="app-header"><div class="header-left"><h1>C# オンライン</h1><nav class="nav-links"><router-link to="/">← 戻る</router-link></nav></div><div class="header-right"><ThemeToggle /></div></header>
