    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b0000000-0000-0000-0000-000000000001"), "content:write", "编辑内容" },
                    { new Guid("b0000000-0000-0000-0000-000000000002"), "content:review", "审核内容" },
                    { new Guid("b0000000-0000-0000-0000-000000000003"), "users:manage", "管理用户" },
                    { new Guid("b0000000-0000-0000-0000-000000000004"), "content:view", "查看内容" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a0000000-0000-0000-0000-000000000001"), "管理员", "admin" },
                    { new Guid("a0000000-0000-0000-0000-000000000002"), "普通成员", "member" }
                });
